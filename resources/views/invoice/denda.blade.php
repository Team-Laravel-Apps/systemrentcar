                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <ul class="list-unstyled">
                                ...
                                <li class="text-muted mt-1"><span class="text-black">Invoice</span> #INV{{ date('sdmy') }}</li>
                            ...
                            <div class="col-xl-4 col-sm-4">
                                <p class="float-end">
                                    @currency(100000)<span style="font-size: 12px;">/hari</span>
                                </p>
                            </div>
                            <hr>
                        </div>
                        <div class="row">
                            <label style="font-size: 12px;" class="text-secondary">Lewat Sewa</label>
                        ...
                        <div class="row text-black">
                            ...
                            <div class="col-xl-12">
                                <p class="float-end fw-bold">Total: @currency($denda)
                                </p>
                            </div>
